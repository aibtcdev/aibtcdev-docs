...
- [DAO Proposals](aibtc-contracts/dao-proposals/README.md)
  ...
  - [Action Proposal Prompts](aibtc-contracts/dao-proposals/action-proposal-prompts.md)
  - [Core Proposals](aibtc-contracts/dao-proposals/core-proposals.md)
- [Smart Wallet](aibtc-contracts/smart-wallet/README.md)
  - [Smart Wallet Prompts](aibtc-contracts/smart-wallet/smart-wallet-prompts.md)
...
- [Endpoints](aibtc-cache/endpoints/README.md)
  - [Contract Calls](aibtc-cache/endpoints/contract-calls/README.md)
    - [API Overview](aibtc-cache/endpoints/contract-calls/overview.md)
    - [Read-Only Function Calls](aibtc-cache/endpoints/contract-calls/read-only-calls.md)
    - [Contract ABI](aibtc-cache/endpoints/contract-calls/contract-abi.md)
    - [Known Contracts](aibtc-cache/endpoints/contract-calls/known-contracts.md)
    - [Decode Clarity Value](aibtc-cache/endpoints/contract-calls/decode-clarity-value.md)
    - [Clarity Value Types](aibtc-cache/endpoints/contract-calls/clarity-value-types.md)
    - [Integration Examples](aibtc-cache/endpoints/contract-calls/integration-examples.md)
